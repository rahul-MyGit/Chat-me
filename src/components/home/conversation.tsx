...
const Conversation = ({ conversation }: { conversation: any }) => {
	...
	const activeBgColumn = selectedConversation?._id === conversation._id;

	return (
		<>
			<div onClick={() => setSelectedConversation(conversation)} className={`flex gap-2 items-center p-3 hover:bg-chat-hover cursor-pointer ${activeBgColumn ? 'bg-gray-tertiary' : ''}`}>
